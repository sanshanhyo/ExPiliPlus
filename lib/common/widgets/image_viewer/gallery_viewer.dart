...
import 'package:ex_piliplus/common/widgets/image_viewer/image.dart';
import 'package:ex_piliplus/common/widgets/image_viewer/loading_indicator.dart';
import 'package:ex_piliplus/common/widgets/image_viewer/viewer.dart';
import 'package:ex_piliplus/common/widgets/scroll_physics.dart';
import 'package:ex_piliplus/main.dart' show tmpPadding;
        ...
        children: [
          ...
          if (PlatformUtils.isDesktop)
            ...
            DialogOption(
              ...
              child: Text(
                context.l10n.imageSaveAllImages,
                style: const TextStyle(fontSize: 14),
              ),
            ),
