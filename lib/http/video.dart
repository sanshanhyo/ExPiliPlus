...
import 'package:ex_piliplus/models/model_rec_video_item.dart';
import 'package:ex_piliplus/models/pgc_lcf.dart';
...
import 'package:ex_piliplus/models_new/popular/popular_series_list/list.dart';
import 'package:ex_piliplus/models_new/popular/popular_series_one/data.dart';
import 'package:ex_piliplus/models_new/triple/pgc_triple.dart';
import 'package:ex_piliplus/models_new/triple/ugc_triple.dart';
import 'package:ex_piliplus/models_new/video/video_ai_conclusion/data.dart';
import 'package:ex_piliplus/models_new/video/video_detail/data.dart';
import 'package:ex_piliplus/models_new/video/video_detail/video_detail_response.dart';
import 'package:ex_piliplus/models_new/video/video_note_list/data.dart';
import 'package:ex_piliplus/models_new/video/video_play_info/data.dart';
import 'package:ex_piliplus/models_new/video/video_relation/data.dart';
import 'package:ex_piliplus/models_new/video/video_shot/data.dart';
...
abstract final class VideoHttp {
  ...
  // Keep the ExPiliPlus caller contract while following the upstream name.
  static Future<String?> vttSubtitles(
    String subtitleUrl, {
    SubtitleFormat format = .vtt,
  }) => getSubtitles(subtitleUrl, format: format);
