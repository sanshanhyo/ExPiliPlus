...
import 'package:ex_piliplus/pages/member_search/child/view.dart';
                  ...
                  children: [
                    TabBar(
                      ...
                      tabs: [
                        Obx(
                          () => Tab(
                            text: context.l10n.searchTabCount(
                              context.l10n.favoriteTabVideos,
