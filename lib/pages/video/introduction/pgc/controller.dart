...
import 'package:ex_piliplus/models_new/video/video_detail/episode.dart'
    hide EpisodeItem;
import 'package:ex_piliplus/models_new/video/video_detail/stat_detail.dart';
                  ...
                  PageUtils.pmShare(
                    ...
                    content: {
                      ...
                      "source_desc": switch (pgcItem.type) {
                        1 => l10n.searchZoneAnime,
                        2 => l10n.searchZoneMovies,
                        3 => l10n.searchZoneDocumentary,
                        4 => l10n.searchZoneChineseAnimation,
                        5 => l10n.mediaTvSeries,
                        6 => l10n.mediaComics,
                        7 => l10n.mediaVarietyShows,
                        _ => null,
                      },
                    },
                  );
