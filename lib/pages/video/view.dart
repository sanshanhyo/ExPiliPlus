...
import 'package:ex_piliplus/common/widgets/keep_alive_wrapper.dart';
import 'package:ex_piliplus/common/widgets/route_aware_mixin.dart';
...
import 'package:ex_piliplus/common/widgets/sliver/video_header.dart';
import 'package:ex_piliplus/common/widgets/svg/play_icon.dart';
import 'package:ex_piliplus/models/common/episode_panel_type.dart';
import 'package:ex_piliplus/models_new/pgc/pgc_info_model/result.dart';
...
import 'package:ex_piliplus/models_new/video/video_tag/data.dart';
import 'package:ex_piliplus/pages/common/common_intro_controller.dart';
import 'package:ex_piliplus/pages/danmaku/view.dart';
import 'package:ex_piliplus/pages/episode_panel/view.dart';
...
import 'package:ex_piliplus/pages/video/introduction/local/view.dart';
import 'package:ex_piliplus/pages/video/introduction/pgc/controller.dart';
import 'package:ex_piliplus/pages/video/introduction/pgc/view.dart';
import 'package:ex_piliplus/pages/video/introduction/pgc/widgets/intro_detail.dart';
import 'package:ex_piliplus/pages/video/introduction/ugc/controller.dart';
import 'package:ex_piliplus/pages/video/introduction/ugc/view.dart';
import 'package:ex_piliplus/pages/video/introduction/ugc/widgets/page.dart';
import 'package:ex_piliplus/pages/video/introduction/ugc/widgets/season.dart';
import 'package:ex_piliplus/pages/video/member/controller.dart';
import 'package:ex_piliplus/pages/video/member/view.dart';
import 'package:ex_piliplus/pages/video/related/view.dart';
import 'package:ex_piliplus/pages/video/reply/controller.dart';
import 'package:ex_piliplus/pages/video/reply/view.dart';
import 'package:ex_piliplus/pages/video/view_point/view.dart';
import 'package:ex_piliplus/pages/video/widgets/header_control.dart';
import 'package:ex_piliplus/pages/video/widgets/player_focus.dart';
...
import 'package:ex_piliplus/plugin/pl_player/view/view.dart';
...
enum VideoDetailTabType { introduction, comments, playlist }
...
class _VideoDetailPageVState extends State<VideoDetailPageV>
  ...
  Widget _buildOverlayToolBar(double scrollRatio) {
    ...
    if (videoDetailController.playedTime == null) {
      ...
      playLabel = l10n.videoPlayNow;
    } else if (plPlayerController!.isCompleted) {
      icon = CustomIcons.replay_rounded;
      playLabel = l10n.videoReplay;
    } else {
      icon = Icons.play_arrow_rounded;
      playLabel = l10n.videoResumePlayback;
    }
    final playBtn = Row(
      spacing: 2,
      mainAxisSize: .min,
          ...
          child: SizedBox(
            ...
            child: Scaffold(
              ...
              body: Column(
                ...
                children: [
                  buildTabBar(
                    introText: context.l10n.videoRelatedVideos,
      ...
      return Stack(
        ...
        children: [
              ...
              title: Row(
                children: [
                  ...
                  SizedBox(
                    ...
                    height: 34,
                    child: IconButton(
                      tooltip: context.l10n.videoBackToHome,
                      icon: const Icon(
                        FontAwesomeIcons.house,
                        size: 15,
                        color: Colors.white,
          ...
          Positioned(
            ...
            bottom: 10,
            child: IconButton(
              tooltip: context.l10n.playerPlay,
  ...
  Widget buildTabBar({
    ...
    final l10n = context.l10n;
    final tabs = <({VideoDetailTabType type, String label})>[
      if (showIntro)
        (
          type: VideoDetailTabType.introduction,
          label: videoDetailController.isFileSource
              ? l10n.videoOfflineVideo
              : introText ?? l10n.videoDescription,
        ),
      if (videoDetailController.showReply)
        (type: VideoDetailTabType.comments, label: l10n.videoComments),
      if (_shouldShowSeasonPanel)
        (type: VideoDetailTabType.playlist, label: l10n.videoPlaylist),
    ];
    ...
    Widget tabBar() {
      ...
      return TabBar(
        ...
        onTap: (value) {
          void animToTop() {
            ...
            switch (tabs[value].type) {
              case VideoDetailTabType.introduction:
                videoDetailController.introScrollCtr?.animToTop();
              case VideoDetailTabType.comments:
                _videoReplyController.animateToTop();
              case VideoDetailTabType.playlist:
                break;
            }
          }
        ...
        tabs: tabs.map((tab) {
          if (tab.type == VideoDetailTabType.comments) {
            return Obx(() {
              ...
              return Tab(
                child: Text(
                  count == -1
                      ? l10n.videoComments
                      : l10n.videoCommentsCount(NumUtils.numFormat(count)),
                  softWrap: false,
                  overflow: .visible,
                ),
              );
            ...
            return Tab(
              child: Text(tab.label, softWrap: false, overflow: .visible),
            );
          }
        }).toList(),
      );
  ...
  void onReversePlay({required bool isSeason}) {
    if (isSeason && videoDetailController.isPlayAll) {
      SmartDialog.showToast(context.l10n.videoSeriesReverseNotSupported);
      return;
    }
