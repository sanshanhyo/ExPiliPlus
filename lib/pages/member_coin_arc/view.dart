...
import 'package:ex_piliplus/pages/member_coin_arc/controller.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          widget.mid == mid
              ? context.l10n.memberMyRecentCoinedVideos
              : context.l10n.memberUserRecentCoinedVideos(widget.name ?? ''),
        ),
      ),
