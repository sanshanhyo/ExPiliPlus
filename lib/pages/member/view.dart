...
import 'package:ex_piliplus/common/widgets/dynamic_sliver_app_bar/dynamic_sliver_app_bar.dart';
...
import 'package:ex_piliplus/pages/coin_log/controller.dart';
import 'package:ex_piliplus/pages/exp_log/controller.dart';
import 'package:ex_piliplus/pages/log_table/view.dart';
import 'package:ex_piliplus/pages/login_devices/view.dart';
import 'package:ex_piliplus/pages/login_log/controller.dart';
import 'package:ex_piliplus/pages/member/controller.dart';
import 'package:ex_piliplus/pages/member/widget/medal_wall.dart';
import 'package:ex_piliplus/pages/member/widget/reserve_button.dart';
import 'package:ex_piliplus/pages/member/widget/user_info_card.dart';
import 'package:ex_piliplus/pages/member_cheese/view.dart';
import 'package:ex_piliplus/pages/member_contribute/controller.dart';
import 'package:ex_piliplus/pages/member_contribute/view.dart';
import 'package:ex_piliplus/pages/member_dynamics/view.dart';
import 'package:ex_piliplus/pages/member_favorite/view.dart';
import 'package:ex_piliplus/pages/member_home/view.dart';
import 'package:ex_piliplus/pages/member_pgc/view.dart';
import 'package:ex_piliplus/pages/member_shop/view.dart';
          ...
          Success(:final response) => Stack(
            children: [
              ...
              if (Pref.showRandomVideoButton &&
                  _userController.fromViewAid?.isNotEmpty != true)
                Positioned(
