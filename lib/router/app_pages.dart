import 'package:ex_piliplus/pages/article/view.dart';
import 'package:ex_piliplus/pages/article_list/view.dart';
import 'package:ex_piliplus/pages/audio/view.dart';
import 'package:ex_piliplus/pages/blacklist/view.dart';
import 'package:ex_piliplus/pages/bubble/view.dart';
import 'package:ex_piliplus/pages/danmaku_block/view.dart';
import 'package:ex_piliplus/pages/dlna/view.dart';
import 'package:ex_piliplus/pages/download/view.dart';
import 'package:ex_piliplus/pages/dynamics/view.dart';
import 'package:ex_piliplus/pages/dynamics_create_vote/view.dart';
import 'package:ex_piliplus/pages/dynamics_detail/view.dart';
import 'package:ex_piliplus/pages/dynamics_topic/view.dart';
import 'package:ex_piliplus/pages/dynamics_topic_rcmd/view.dart';
import 'package:ex_piliplus/pages/fan/view.dart';
import 'package:ex_piliplus/pages/fav/view.dart';
import 'package:ex_piliplus/pages/fav_create/view.dart';
import 'package:ex_piliplus/pages/fav_detail/view.dart';
import 'package:ex_piliplus/pages/fav_search/view.dart';
import 'package:ex_piliplus/pages/follow/view.dart';
...
import 'package:ex_piliplus/pages/later/view.dart';
import 'package:ex_piliplus/pages/later_search/view.dart';
...
import 'package:ex_piliplus/pages/member_dynamics/view.dart';
import 'package:ex_piliplus/pages/member_guard/view.dart';
import 'package:ex_piliplus/pages/member_profile/view.dart';
import 'package:ex_piliplus/pages/member_search/view.dart';
import 'package:ex_piliplus/pages/member_upower_rank/view.dart';
import 'package:ex_piliplus/pages/member_video_web/archive/view.dart';
import 'package:ex_piliplus/pages/member_video_web/season_series/view.dart';
import 'package:ex_piliplus/pages/msg_feed_top/at_me/view.dart';
import 'package:ex_piliplus/pages/msg_feed_top/like_detail/view.dart';
import 'package:ex_piliplus/pages/msg_feed_top/like_me/view.dart';
import 'package:ex_piliplus/pages/msg_feed_top/reply_me/view.dart';
...
import 'package:ex_piliplus/pages/setting/pages/bar_set.dart';
import 'package:ex_piliplus/pages/setting/pages/color_select.dart';
import 'package:ex_piliplus/pages/setting/pages/display_mode.dart';
import 'package:ex_piliplus/pages/setting/pages/font_size_select.dart';
import 'package:ex_piliplus/pages/setting/pages/logs.dart';
import 'package:ex_piliplus/pages/setting/pages/play_speed_set.dart';
import 'package:ex_piliplus/pages/setting/view.dart';
import 'package:ex_piliplus/pages/settings_search/view.dart';
import 'package:ex_piliplus/pages/space_setting/view.dart';
import 'package:ex_piliplus/pages/sponsor_block/view.dart';
import 'package:ex_piliplus/pages/subscription/view.dart';
import 'package:ex_piliplus/pages/subscription_detail/view.dart';
import 'package:ex_piliplus/pages/video/view.dart';
import 'package:ex_piliplus/pages/webview/view.dart';
import 'package:ex_piliplus/pages/whisper/view.dart';
import 'package:ex_piliplus/pages/whisper_detail/view.dart';
